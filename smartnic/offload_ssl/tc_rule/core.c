...
void TestAddDeleteSeparate()
{
    ...
    int i, port_start = 101, port_end = 10100;
...
int main(int argc, char *argv[])
{
    ...
    flower->key.ipv4.ipv4_src = htonl(0xa002b04);
    flower->mask.ipv4.ipv4_src = 0xffffffff;
    flower->key.tcp_src = htons(prio); /* use same number with priority */
    flower->mask.tcp_src = 0xffff;
    ...
    flower_reverse->key.ipv4.ipv4_src = htonl(0xa002b04);
    flower_reverse->mask.ipv4.ipv4_src = 0xffffffff;
    flower_reverse->key.tcp_src = htons(prio); /* use same number with priority */
    flower_reverse->mask.tcp_src = 0xffff;
