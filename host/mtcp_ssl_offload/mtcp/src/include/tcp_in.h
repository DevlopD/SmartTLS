...
#define TCP_EXTENDED_MSS 	    65495
/* #if GSO_ENABLED */
/* #define TCP_INITIAL_WINDOW		TCP_EXTENDED_MSS*2	// initial window size */
/* #else */
...
#ifdef SSL_OFF
int
ProcessTCPMetaPacket(struct mtcp_manager *mtcp, uint32_t cur_ts, const int ifidx,
					const struct iphdr* iph, int ip_len);
#endif /* SSL_OFF */
