...
/* #if GSO_ENABLED */
	uint8_t * (*get_gso_wptr)(struct mtcp_thread_context *ctx, int ifidx, uint16_t len, uint8_t **opaque);
	int32_t   (*mark_gso_pkt)(struct mtcp_thread_context *ctx, uint8_t *opaque);
/* #endif */
